...
func (h *gRPCHandler) CreateTopic(ctx context.Context, req *pb.CreateTopicRequest) (*pb.CreateTopicResponse, error) {
	return h.service.CreateTopic(ctx, req)
}
func (h *gRPCHandler) GetTopics(ctx context.Context, req *pb.GetTopicsRequest) (*pb.GetTopicsResponse, error) {
	return h.service.GetTopics(ctx, req)
}
func (h *gRPCHandler) CreateSection(ctx context.Context, req *pb.CreateSectionRequest) (*pb.CreateSectionResponse, error) {
	return h.service.CreateSection(ctx, req)
}
func (h *gRPCHandler) GetSections(ctx context.Context, req *pb.GetSectionsRequest) (*pb.GetSectionsResponse, error) {
	return h.service.GetSections(ctx, req)
}

func (h *gRPCHandler) GetQuestions(ctx context.Context, req *pb.GetQuestionsRequest) (*pb.GetQuestionsResponse, error) {
	return h.service.GetQuestions(ctx, req)
}
func (h *gRPCHandler) GetQuestion(ctx context.Context, req *pb.GetQuestionRequest) (*pb.GetQuestionResponse, error) {
	return h.service.GetQuestion(ctx, req)
}
func (h *gRPCHandler) CreateQuestion(ctx context.Context, req *pb.CreateQuestionRequest) (*pb.CreateQuestionResponse, error) {
	return h.service.CreateQuestion(ctx, req)
}
...
func (h *gRPCHandler) GenerateExam(ctx context.Context, req *pb.GenerateExamRequest) (*pb.CreateExamResponse, error) {
	return h.service.GenerateExam(ctx, req)
}
func (h *gRPCHandler) GetExamDetails(ctx context.Context, req *pb.GetExamDetailsRequest) (*pb.GetExamDetailsResponse, error) {
	return h.service.GetExamDetails(ctx, req)
}
...
func (h *gRPCHandler) RequestExamAccess(ctx context.Context, req *pb.RequestExamAccessRequest) (*pb.RequestExamAccessResponse, error) {
	return h.service.RequestExamAccess(ctx, req)
}
func (h *gRPCHandler) ApproveExamAccess(ctx context.Context, req *pb.ApproveExamAccessRequest) (*pb.ApproveExamAccessResponse, error) {
	return h.service.ApproveExamAccess(ctx, req)
}
func (h *gRPCHandler) CheckExamAccess(ctx context.Context, req *pb.CheckExamAccessRequest) (*pb.CheckExamAccessResponse, error) {
	return h.service.CheckExamAccess(ctx, req)
}

func (h *gRPCHandler) SubmitExam(ctx context.Context, req *pb.SubmitExamRequest) (*pb.SubmitExamResponse, error) {
	return h.service.SubmitExam(ctx, req)
}
func (h *gRPCHandler) GetSubmission(ctx context.Context, req *pb.GetSubmissionRequest) (*pb.GetSubmissionResponse, error) {
	return h.service.GetSubmission(ctx, req)
}
...
func (h *gRPCHandler) GetExamViolations(ctx context.Context, req *pb.GetExamViolationsRequest) (*pb.GetExamViolationsResponse, error) {
	return h.service.GetExamViolations(ctx, req)
}
...
func (h *gRPCHandler) UnassignExamFromClass(ctx context.Context, req *pb.AssignExamToClassRequest) (*pb.AssignExamToClassResponse, error) {
	return h.service.UnassignExamFromClass(ctx, req)
}
