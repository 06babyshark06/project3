...
func (UnimplementedCourseServiceServer) GetCourseDetails(context.Context, *GetCourseDetailsRequest) (*GetCourseDetailsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCourseDetails not implemented")
}
...
func (UnimplementedCourseServiceServer) GetMyCourses(context.Context, *GetMyCoursesRequest) (*GetMyCoursesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMyCourses not implemented")
}
...
func (UnimplementedCourseServiceServer) GetCourseCount(context.Context, *GetCourseCountRequest) (*GetCourseCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCourseCount not implemented")
}
