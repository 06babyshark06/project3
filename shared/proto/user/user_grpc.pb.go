...
func (UnimplementedUserServiceServer) GetClasses(context.Context, *GetClassesRequest) (*GetClassesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetClasses not implemented")
}
...
func (UnimplementedUserServiceServer) AddMembersBulk(context.Context, *AddMembersRequest) (*AddMembersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddMembersBulk not implemented")
}
...
func (UnimplementedUserServiceServer) CheckUserInClass(context.Context, *CheckUserInClassRequest) (*CheckUserInClassResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckUserInClass not implemented")
}
func (UnimplementedUserServiceServer) JoinClassByCode(context.Context, *JoinClassByCodeRequest) (*JoinClassByCodeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method JoinClassByCode not implemented")
}
